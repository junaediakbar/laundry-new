...
import { triggerOrderWhatsAppNotification, type WhatsAppEventKey } from "@/lib/whatsapp-notifications"
...
export async function POST(request: Request) {
  ...
  try {
    const result = await triggerOrderWhatsAppNotification({ orderId, eventKey })
