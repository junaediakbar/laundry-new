  ...
  return {
    groups: [
      ...
      },
      {
        ...
        title: "Produksi",
        tasks: [
          { key: "rontok", label: "Rontok (opsional)", percent: 3 },
          { key: "sikat", label: "Sikat", percent: 3 },
          { key: "bilas", label: "Bilas", percent: 8 },
          { key: "downy", label: "Downy", percent: 1.5 },
          { key: "rumbai", label: "Rumbai (opsional)", percent: 1.5 },
